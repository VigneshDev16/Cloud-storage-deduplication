...
$con = dbconnect();
$fid = $_GET['fid'];
$query = mysqli_query($con, "SELECT * from file WHERE  fid= '$fid' and uid ='$uid'");
$query1 = mysqli_fetch_array($query);
$fname = $query1['name'];
$lid = $query1['lid'];
if($lid!= 0) $query = mysqli_query($con, "SELECT * from file WHERE  fid= '$lid'");
else $query = mysqli_query($con, "SELECT * from file WHERE  fid= '$fid' and uid ='$uid'");
...
<td><label>File Contents :</label></td>
<td><input type="text" value="<?php echo $data; ?>" style="width:500px;height:200px" name="text" readonly></td></tr>
